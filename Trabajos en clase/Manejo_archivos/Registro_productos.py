import csv
#armar una lista vacia, usar el realine y pasar cada linea como diccionario "a mano", no usar la libreria csv,prestar atencion a la decodificacion en la lectura, mirar metodo "enumerate" 
